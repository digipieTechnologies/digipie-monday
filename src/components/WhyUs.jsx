...
const features = [
  {
    icon: (
      ...
      >
        <path
          d="M11 2l2.5 5.5H19l-4.5 3.5 1.7 5.5L11 13.5l-5.2 3 1.7-5.5L3 7.5h5.5L11 2z"
          stroke="currentColor"
          strokeWidth="1.6"
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M11 3v4M11 15v4M3 11h4M15 11h4"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
        />
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M11 3C6.6 3 3 6.6 3 11s3.6 8 8 8 8-3.6 8-8"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
        />
        <path
          d="M15 3l4 4-8 8-4-2-2-4 10-6z"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinejoin="round"
        />
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              >
                {[
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] font-semibold text-white px-2.5 py-1 rounded-full ${item.color}`}
                    >
                      {item.status}
                    </span>
                  </motion.div>
          ...
          >
            ...
            <p className="text-body text-base sm:text-lg leading-relaxed mb-10">
              Anyone can create boards. We build systems that actually change
