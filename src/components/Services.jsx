const services = [
  {
    ...
    points: ['Custom board architecture', 'Workflow automations', 'Third-party integrations'],
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden="true">
    ...
    points: ['Workflow audit & mapping', 'Bottleneck elimination', 'ROI-focused redesign'],
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden="true">
        <path d="M5 20l4-4 4 4 4-6 4 2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
        <rect x="3" y="4" width="22" height="20" rx="2" stroke="currentColor" strokeWidth="1.8"/>
      </svg>
    ),
    ...
    points: ['Executive dashboards', 'KPI tracking boards', 'Automated reporting'],
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden="true">
        ...
        <path d="M14 10h2a4 4 0 014 4v0" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
      </svg>
    ),
    color: 'text-primary bg-primary-light',
  ...
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden="true">
        <path d="M6 8l8-4 8 4v8l-8 4-8-4V8z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/>
        <path d="M14 12v8M6 8l8 4 8-4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
      </svg>
    ),
    color: 'text-accent bg-accent-light',
  ...
  },
  {
    ...
    points: ['Monthly optimization reviews', 'Priority support SLA', 'Feature rollout guidance'],
  },
]
      ...
      <div className="max-w-300 mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
          ...
          <p className="text-body text-base sm:text-lg leading-relaxed">
            From initial setup to long-term growth, we cover every stage of your monday.com journey.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s) => (
            ...
            >
              {/* Icon */}
              <div className={`inline-flex items-center justify-center w-12 h-12 rounded-md ${s.color} mb-5 transition-transform group-hover:scale-110 duration-300`}>
                {s.icon}
              </div>
                  ...
                  <li key={pt} className="flex items-center gap-2 text-sm text-body">
                    <span className="w-4 h-4 rounded-full bg-teal/20 flex items-center justify-center flex-shrink-0">
                      <svg width="8" height="8" viewBox="0 0 8 8" fill="none" aria-hidden="true">
                        <path d="M1.5 4l2 2 3-3" stroke="#00C9A7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </span>
                    {pt}
                  </li>
