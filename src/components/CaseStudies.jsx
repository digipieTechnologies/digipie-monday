const cases = [
  {
    ...
    challenge:
      "Managing 200+ shipments across 3 teams with spreadsheets - updates were delayed, errors were costly.",
    solution:
      "Built a unified monday.com workspace with automated status updates, real-time dashboards, and Slack integrations.",
    results: [
  ...
  },
  {
    ...
    challenge:
      "Sales reps used 4 different tools. Leads fell through the cracks and managers had no pipeline visibility.",
    solution:
      "Consolidated CRM into monday.com - full lead lifecycle, deal stages, automated follow-ups and executive dashboards.",
    results: [
  ...
  },
  {
    ...
    challenge:
      "Project timelines constantly slipping. Clients complained about lack of transparency. Team morale was low.",
    solution:
      "Implemented a client-facing monday.com portal with real-time project tracking, approval workflows, and automated reporting.",
    results: [
        ...
        <div className="grid lg:grid-cols-3 gap-7">
          {cases.map((c) => (
            ...
            >
              {/* Tag */}
              <span
                className={`self-start text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full mb-5 ${c.tagColor}`}
              >
                {c.tag}
              </span>
              ...
              <div className="flex items-center gap-3 mb-6">
                <div
                  className={`w-10 h-10 rounded-sm ${c.badge} flex items-center justify-center text-white font-bold text-base`}
                >
                  {c.company[0]}
                </div>
                <div>
