      ...
      <div className="max-w-[1400px] mx-auto px-4 pt-16 pb-12">
        <div className="grid md:grid-cols-[1fr_auto] gap-12 items-start">
          ...
          <div className="max-w-sm">
            ...
            <Link
              to="/"
              className="h-auto max-w-40 bg-white inline-block"
            ...
            <p className="text-sm text-white/60 leading-relaxed mb-6">
              We help businesses implement, scale, and get the most out of
              monday.com - as a certified partner with 1.5+ years of hands-on
              expertise.
            </p>
