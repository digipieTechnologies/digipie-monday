...
const testimonials = [
  {
    quote:
      "Digipie didn't just set up monday.com for us — they rewired how our entire ops team thinks about work. The efficiency gains were visible within the first two weeks.",
    name: "Sarah Mitchell",
  ...
  {
    quote:
      "We had tried to implement monday.com ourselves and failed. Digipie came in, understood our sales process deeply, and built a CRM that our reps actually love using.",
    name: "James Okafor",
  ...
  {
    quote:
      "The client portal they built inside monday.com was a game-changer. Our clients can see project progress in real-time — no more status call overheads.",
    name: "Priya Sharma",
  ...
  {
    quote:
      "From the first discovery call to go-live, the Digipie team was professional, fast, and genuinely invested in our success. Highly recommend to any team on monday.com.",
    name: "Daniel Cruz",
  ...
  {
    quote:
      "The training sessions were excellent — practical, role-specific, and not boring. Our team went from reluctant users to monday.com advocates in a month.",
    name: "Emma Lawson",
  ...
  {
    quote:
      "Best ROI we've gotten from any software investment. Digipie's ongoing support means our setup keeps improving as we grow. True partners.",
    name: "Arjun Mehta",
...
export default function Testimonials() {
  ...
  const col1Testimonials = [
    ...testimonials.slice(0, mid),
    ...testimonials.slice(0, mid),
  ];
  const col2Testimonials = [
    ...testimonials.slice(mid),
    ...testimonials.slice(mid),
  ];
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-start text-left">
            ...
            <p className="text-body text-base sm:text-lg leading-relaxed mb-8">
              Don't take our word for it — hear from the teams we've helped
              transform their workflows, speed up operations, and achieve real
              growth.
            </p>
